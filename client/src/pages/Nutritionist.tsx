...
const scenarios = [
  {
    ...
    text: "Зоя составит рацион с учётом ваших целей: похудение, набор массы, здоровье ребёнка, спортивное питание — с использованием продуктов фермы.",
    color: "emerald",
  },
  {
    icon: Baby,
    title: "Питание для детей",
    text: "Козье молоко ближе к грудному по структуре белка. Зоя подскажет, как вводить его в рацион ребёнка безопасно и с максимальной пользой.",
    color: "amber",
  },
  {
    icon: FlaskConical,
    title: "Научная экспертиза",
    text: "Зоя знает состав молока каждой породы на ферме, опирается на научные исследования и объяснит разницу между козьим, овечьим и коровьим.",
    color: "blue",
  },
  {
    icon: Utensils,
  ...
  },
  {
    ...
    text: "Непереносимость лактозы? Аллергия на белок коровьего молока? Зоя объяснит, почему козье молоко может быть решением, и подберёт продукты.",
    color: "teal",
  },
];
...
const scienceFacts = [
  {
    ...
    title: "A2-казеин",
    value: "100%",
    desc: "Козье молоко содержит только A2-казеин — легкоусвояемый белок, не вызывающий дискомфорт в отличие от A1-казеина коровьего молока.",
    source: "Pal et al., European Journal of Clinical Nutrition, 2015",
  },
  {
    icon: FlaskConical,
    title: "Жировые глобулы",
    value: "в 2× меньше",
    desc: "Жировые шарики козьего молока в 2 раза мельче коровьих — они усваиваются быстрее и не перегружают пищеварение.",
  ...
  },
  {
    ...
    title: "Кальций",
    value: "+13%",
    desc: "В козьем молоке на 13% больше кальция, чем в коровьем, при лучшей биодоступности для костной ткани.",
  ...
  },
  {
    ...
    title: "Овечье молоко",
    value: "7.5% жирности",
    desc: "Овечье молоко — самое питательное: 7.5% жира, 5.6% белка, в 2 раза больше витамина B12, чем в коровьем. Идеально для сыроварения.",
        ...
        <div className="container relative">
          <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            ...
            <div className="max-w-2xl">
              ...
              >
                Зоя — ваш персональный AI-нутрициолог. Она знает всё о пользе козьего и овечьего молока, 
                составит план питания под ваши цели и расскажет, почему продукты от конкретного животного — 
                это совсем другой уровень заботы о здоровье.
              </motion.p>
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-muted-foreground">
                        Нутрициолог • Диетолог • Эксперт по молочной продукции
                      </p>
                    </div>
                  </div>
                </div>
