...
const values = [
  ...
  },
  {
    ...
    text: "Англо-нубийские козы, альпийские козы, остфризские и лаконские овцы — генетика европейского уровня, обосновывающая премиальное качество.",
    icon: Milk,
    stat: "4",
    statLabel: "породы",
  },
