/**
 * /farm/cheesemaker — Cheesemaker ARM (Automated Workstation) placeholder.
 *
 * Mobile-first interface for milk reception and processing.
...
import { Loader2, LogOut, Construction, FlaskConical } from "lucide-react";
    ...
    <div className="min-h-dvh flex flex-col bg-[oklch(0.97_0.015_90)]">
      ...
      <header className="flex items-center justify-between px-4 py-3 bg-white border-b border-[oklch(0.9_0.02_90)] shadow-sm">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-[oklch(0.72_0.15_75)] flex items-center justify-center">
          ...
          <div>
            ...
            <p className="text-xs text-[oklch(0.52_0.04_80)]">Сыродел</p>
          </div>
        </div>
        <Button
          variant="ghost"
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6">
        <div className="w-24 h-24 rounded-full bg-[oklch(0.88_0.10_80)] flex items-center justify-center mb-6">
          <Construction className="w-12 h-12 text-[oklch(0.72_0.15_75)]" />
        </div>
        ...
        <p className="text-sm text-[oklch(0.52_0.04_80)] text-center max-w-xs mb-8">
          Модуль приёмки молока и управления переработкой будет доступен в следующем обновлении.
        ...
        <div className="w-full max-w-sm space-y-3">
          ...
          >
            <div className="w-10 h-10 rounded-lg bg-[oklch(0.88_0.10_80)] flex items-center justify-center flex-shrink-0">
              <FlaskConical className="w-5 h-5 text-[oklch(0.72_0.15_75)]" />
            </div>
            <div className="text-left">
              <p className="text-sm font-semibold text-[oklch(0.22_0.04_60)]">
                Переработка
