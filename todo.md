...
- [ ] Добавить редактирование title и alt для каждого фото в галерее животного
- [ ] Подключить сохранение метаданных фото к серверному API или подготовить совместимый flow
- [ ] Добавить Vitest на helper-логику редактирования метаданных фото, если она будет вынесена
