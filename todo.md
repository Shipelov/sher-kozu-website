...
- [ ] Zoya profile questionnaire: Создать анкету первого персонального запроса с обязательными полями и явным подтверждением отсутствия ограничений
- [ ] Zoya profile session UX: Показывать компактное подтверждение активного профиля с действиями «Использовать», «Изменить», «Выбрать другой»
- [ ] Zoya context assembler: Объединять профиль, подтверждённый продуктовый план, доступные варианты, RAG-знания и недостающие уточнения
- [ ] Zoya evidence levels: Разделять факты клиента, факты фермы, проверенные знания и справочные оценки КБЖУ
- [ ] Zoya AI orchestration: Формировать структурированный prompt и использовать единый внешний AI-контур для tRPC и SSE
- [ ] Zoya response validation: Проверять продукты, ограничения, медицинскую безопасность, арифметику и маркировку справочных данных до показа ответа
- [ ] Zoya recommendation UX: Выводить «Учтено в расчёте», основной вариант, 1–2 замены, КБЖУ, долю продукции и источники
- [ ] Zoya rebuild tests: Покрыть мультипрофили, анкету, выбор профиля, уточнения, продуктовый RAG, AI и валидацию сквозными тестами
- [ ] Zoya rebuild UX audit: Проверить первый запрос, повторную сессию, смену профиля, редактирование и персональное меню в браузере
- [ ] Zoya rebuild validation: Выполнить полный Vitest, TypeScript и production build перед чекпоинтом
