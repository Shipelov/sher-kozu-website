...
path = Path('client/src/pages/AdminClub.tsx')
text = path.read_text()
start = text.index('          <TabsContent value="bitrix" className="space-y-6">')
end = text.index('          <TabsContent value="activity"', start)
new_block = '''          <TabsContent value="bitrix" className="space-y-6">
